...
const translations = {
    ru: {
        ...
        program2: 'Сопровождение на препаратах для снижения массы тела (3 месяца)',
        program3: 'Программа похудения или набора веса (неделя)',
        program4: 'Программа похудения или набора веса (месяц)',
    ...
    kk: {
        ...
        program2: 'Салмақ төмендетуге арналған препараттарда сүйемелдеу (3 ай)',
        program3: 'Салмақ жоғалту немесе салмақ қосу бағдарламасы (апта)',
        program4: 'Салмақ жоғалту немесе салмақ қосу бағдарламасы (ай)',
